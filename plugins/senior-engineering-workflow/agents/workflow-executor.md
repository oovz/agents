...
description: Execution worker for implementing well-scoped, settled code changes and running validation commands. Uses a cost-effective model with max reasoning effort to produce quality implementation at lower cost.
model: inherit
effort: max
maxTurns: 30
---
